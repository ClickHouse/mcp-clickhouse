...
- `mcp_clickhouse/mcp_server.py`: Startup assembly, FastMCP server construction, tool and prompt registration, ClickHouse execution, pagination, and health checks.
