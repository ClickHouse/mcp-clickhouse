...
- `mcp_clickhouse/mcp_server.py`: Dotenv loading, FastMCP server construction, tool and prompt registration, ClickHouse and chDB execution, pagination, and health checks.
- `mcp_clickhouse/auth.py`: HTTP/SSE authentication and FastMCP provider environment compatibility.
